    ...
    .resTitle {
        ...
        .webResPage {
          ...
          .webTitle {
            ...
            .webTitle div {
              background: url(http://p6alxlphh.bkt.clouddn.com/handdrag-line.png) no-repeat 50% 0 / contain;
              width: 100%;
              height: 2px;
              margin: 40px 0 35px;
              position: relative;
