...
<body class="page-header-fixed" >
    ...
    <div class="pagin" style="text-align: center;margin-top:100px">
		...
		<a href="newShow.do?currentPage=1">首页</a>
		<c:if test="${currentPage != 1 }">
		<a href="newShow.do?currentPage=${currentPage-1 }">上一页</a>
		</c:if>
		<c:if test="${currentPage != pages.totalPageCount }">
		<a href="newShow.do?currentPage=${currentPage+1 }">下一页</a>
		</c:if>
		<a href="newShow.do?currentPage=${pages.totalPageCount}">尾页</a>
		<span>当前第${currentPage}页</span>
   		<span>共${pages.totalPageCount}页</span>
	
		<div class="message" style="text-align: center">共<i class="blue">${pages.NewCount}</i>条记录，当前显示第&nbsp;<i class="blue">${currentPage}&nbsp;</i>页</div>
    	<form action="newShow.do">
