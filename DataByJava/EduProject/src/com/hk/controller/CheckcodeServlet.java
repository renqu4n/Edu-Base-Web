...
public class CheckcodeServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		int width = 120;
		int height = 30;
		// 1锟斤拷锟斤拷锟斤拷一锟斤拷 锟节达拷锟叫伙拷锟斤拷图片
		BufferedImage bufferedImage = new BufferedImage(width, height,
				BufferedImage.TYPE_INT_RGB);

		// 2锟斤拷锟斤拷锟斤拷色
		Graphics graphics = bufferedImage.getGraphics(); // 通锟斤拷 graphics锟斤拷锟斤拷 锟斤拷锟斤拷图片
		// 锟斤拷锟斤拷锟斤拷色
		...
		// 锟斤拷锟斤拷锟侥革拷锟斤拷 --- 锟斤拷锟斤拷content锟叫筹拷取锟侥革拷锟斤拷
		...
		for (int i = 0; i < 4; i++) { // 循锟斤拷锟侥达拷
			// 为锟斤拷 锟斤拷锟斤拷锟阶拷嵌锟� -30 ---- 30
			double jiaodu = random.nextInt(60) - 30;
			// 锟斤拷锟斤拷转锟角讹拷 锟斤拷锟姐弧锟斤拷
			double theta = jiaodu / 180 * Math.PI;
			System.out.println(theta);

			int index = random.nextInt(content.length());
			char letter = content.charAt(index); // letter 锟斤拷证锟斤拷锟斤拷锟斤拷
		...
		// 锟斤拷图片锟斤拷锟斤拷锟� 锟斤拷锟斤拷锟� ImageIO
		// 锟斤拷锟节达拷锟酵计� 通锟斤拷 锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷 写锟斤拷 jpg锟斤拷式图片
