...
<body class="page-header-fixed" >
    ...
    <div class="page-container row-fluid">
        ...
        <td width="80" height="30">${role.id}</td>
        <td width="80" height="30">${role.name}</td>
        <c:forEach items="${user.menus}" var="menu">
        <td width="80" height="30"><input name="" type="checkbox" style=""/>${menu.name}</label></td>
        </c:forEach>
    ...
    <input type="submit" value="提交" style="text-align: center;width: 150px;height: 50px">
        </form>        
                </div>
