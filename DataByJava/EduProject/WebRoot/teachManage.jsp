...
<body class="page-header-fixed" >
    ...
    <div class="page-container row-fluid">
        ...
        <th></th>
        <th>ID</th>
        <th width="250">教师名称</th>
        <th width="250">教师心声</th>
        <th width="250">邮箱地址</th>
        <th width="250">操作</th>
        </tr>
        </thead>
        <tbody>
		<c:forEach items="${pages.Teach}" var="Teach">
        <tr>
        <td></td>
        <td width="250">${Teach.id}</td>
        <td width="250">${Teach.user_name}</td>
        <td width="250">${Teach.user_think}</td>
        <td width="250">${Teach.user_email}</td>
        <td width="250">     
    ...
    <div class="pagin" style="text-align: center;margin-top:100px">
		...
		<div class="message" style="text-align: center">共<i class="blue">${pages.TeachCount}</i>条记录，当前显示第&nbsp;<i class="blue">${currentPage}&nbsp;</i>页</div>
    	<form action="teachShow.do">
